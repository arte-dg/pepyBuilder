    ...
    */
    public function require_include_files(){
       ...
       if( htbuilder_get_option( 'enablecustomtemplate', 'htbuilder_templatebuilder_tabs', 'on' ) == 'on' ){
           ...
           // require(  __DIR__ .'/../classes/class.init_widgets_control.php' );
            require(  __DIR__ .'/../classes/class.custom-metabox.php' );
    ...
    public function add_category( $elements_manager ) {
       $elements_manager->add_category(
            'ht_builder',
            [
                'title' => __( 'pepyBuilder', 'ht-builder' ),
    ...
    public function admin_notice_missing_main_plugin() {
        ...
        $message = sprintf(
            ...
            '<strong>' . esc_html__( 'pepyBuilder', 'ht-builder' ) . '</strong>',
    ...
    public function plugin_redirect_option_page() {
        if ( get_option( 'htbuilder_do_activation_redirect', false ) ) {
            ...
            if( !isset( $_GET['activate-multi'] ) ){
                wp_redirect( admin_url('admin.php?page=htbuilder') );
            }
        }
    }
